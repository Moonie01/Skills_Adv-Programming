...
# -> the dashboard will contain an 'instructio' page to explain further details
...
server <- function(input, output, session) {
  ...
  # Helper functions for the sub-tab "stock_perf" within "individual_stock_analysis"
...
################################################################################
#### Disclaimer: We ackowledge the use of ChatGPT for aid in the writing of this document